...
class Group_model extends CI_Model{
	...
	public final function __construct()
	{
		...
		$this->tablename	= 'sys_group_distributor';
	...
	{
		$query = $this->db->get_where($this->tablename, array('active' => '1'), $this->per_page, $start);
	...
	{
		$query = $this->db->get_where($this->tablename, array('active' => 1));
	...
	public final function delete($id)
	{
		...
		if($this->db->update($this->tablename, array('active' => 0))){
			return true;
		}
