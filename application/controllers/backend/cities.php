...
class Cities extends CI_Controller{
	...
	public final function __construct()
	{
		...
		$this->load->model('city_model', 'data_model');
		$this->load->model('state_model');
		$this->url = 'admin/cidades/';
	...
	public final function search($state_id = '', $data = array())
	{
		$data = $this->data_model->by(array('state_id' => $state_id, 'status_id' => 1));
