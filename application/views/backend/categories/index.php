	...
	<div class="col-md-12">
		<div class="widget">
			...
			<div class="widget-body">
				<div class="row">
					<div class="col-md-4 col-sm-4">
						<a href="<?=site_url('admin/categorias/adicionar');?>" class="btn btn-primary btn-block">Adicionar Novo Registro</a>
					</div>
				</div>
			</div>
					...
					<table class="table table-condensed table-striped table-hover table-bordered pull-left" id="data-table">    
						...
						<tbody>
							...
							<tr class="gradeX">
								...
								<td>
									<a href="<?=site_url('admin/categorias/editar/'.$grupo['id'].'/'.$grupo['idHash']);?>" class="actions-icons">
										<img src="<?=site_url('resources/backend/img/edit-icon.png');?>" alt="editar" class="icons">
									</a>
									<a href="<?=site_url('admin/categorias/remover/'.$grupo['id'].'/'.$grupo['idHash']);?>" class="delete-row" data-original-title="Delete">
