                ...
                <div class="row demography">
                  <div class="col-md-4 col-sm-4">
                    <div class="show-total">
                      <div class="male">
                        <span class="icon"><img src="img/male.png" alt="Male" /></span> 68%
                      </div>
                      <div class="female">
                        <span class="icon"><img src="img/female.png" alt="Female" /></span> 32%
                      </div>
            ...
            <div class="widget">
              ...
              <div class="widget-body">
                <ul class="comments">
                  ...
                  <li>
                    <div class="user pull-left">
                      <img src="img/avatar-5.png" alt="user">
                    </div>
                    <div class="info">
                      <div class="name">
                        <a href="#">Henrik</a>
                  ...
                  <div class="viewport">
                    <div class="overview">
                      <ul class="chats">
                        ...
                        <li class="out">
                          <img class="avatar" alt="" src="img/avatar-4.png">
                          <div class="message">
                            <span class="arrow">
                            </span>
                            <a href="#" class="name">
                        ...
                        <li class="in">
                          <img class="avatar" alt="" src="img/avatar-8.png">
                          <div class="message">
                            <span class="arrow">
                            </span>
                            <a href="#" class="name">
                        ...
                        <li class="in">
                          <img class="avatar" alt="" src="img/avatar-7.png">
                          <div class="message">
                            <span class="arrow">
                            </span>
                            <a href="#" class="name">
                        ...
                        <li class="in">
                          <img class="avatar" alt="" src="img/avatar-5.png">
                          <div class="message">
                            <span class="arrow">
                            </span>
                            <a href="#" class="name">
                        ...
                        <li class="out">
                          <img class="avatar" alt="" src="img/avatar-6.png">
                          <div class="message">
                            <span class="arrow">
                            </span>
                            <a href="#" class="name">
              ...
              <div class="widget-body">
                <div class="row gallery">
                  <div class="col-md-3 col-sm-6">
                    <div class="visual">
                      <img src="../../../lh3.googleusercontent.com/-2bwVLxkBp4s/UhQgsPWp4sI/AAAAAAAAAow/ONJkUXwK094/w816-h612-no/DSC05914.JPG" alt="Slick Admin"/>
                      <div class="mask">
                        <h4>Hover Style</h4>
                  ...
                  <div class="col-md-3 col-sm-6">
                    <div class="visual">
                      <img src="../../../fbcdn-sphotos-b-a.akamaihd.net/hphotos-ak-ash3/1044333_568385483212358_1782121117_n.jpg" alt="Slick Admin"/>
                      <div class="mask">
                        <h4>Hover Style</h4>
                  ...
                  <div class="col-md-3 col-sm-6">
                    <div class="visual">
                      <img src="../../../lh3.googleusercontent.com/-Ogzm_G380UU/UhQeaYYEmrI/AAAAAAAAAoE/_gkyiYmhvXk/w816-h612-no/DSC05804.JPG" alt="Slick Admin"/>
                      <div class="mask">
                        <h4>Hover Style</h4>
                  ...
                  <div class="col-md-3 col-sm-6">
                    <div class="visual">
                      <img src="../../../lh5.googleusercontent.com/-qd7ZXSodT7c/UhQhRkkZK3I/AAAAAAAAApQ/eAAkY4eBc-o/w816-h612-no/DSC05369.JPG" alt="Slick Admin"/>
                      <div class="mask">
                        <h4>Hover Style</h4>
